...
- [Hashicorp Terraform](https://github.com/mauve) - creating the [vscode-terraform](https://github.com/opentofu/vscode-terraform) extension, which was used as a starting point and inspiration for this extension.
